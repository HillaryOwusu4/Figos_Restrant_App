...
const Contact_us = () => {
  ...
  const InputBlurHandler = ()=>{
   ...
   let url ='https://veggie-restuarant-default-rtdb.firebaseio.com/UserAddress.json'
    ...
    return ( <div className="w-full h-[100%] flex  items-center justify-center">
      <div className={`${classes.grid } w-[80%] h-full`}>
        <div className={`${classes.Address }  bg-zinc-900  flex justify-end items-center`}>
            <div className="w-[68%] h-[80%]">
                <div className="w-[100%] flex flex-col justify-center items-center h-[25%]">
                    <p className='text-[36px] w-[80%]  text-gray-100 text-gray-800'>Get in Touch</p>
                    <p className='w-[80%] text-gray-100'>Feel free to drop us a line below!</p>
                </div>
        ...
        <div className={`${classes.Form }  bg-red-600 flex justify-center items-center`}>
